...
(function() {
  ...
  FT("formatting_linkEmail",
     "[link&formatting&formatting-link <][link rbac@example.com][link&formatting&formatting-link >]");
  ...
  MT("linkEmail",
     "[link <rbac@example.com>] foo");

  MT("linkEmailDouble",
     "[link <rbac@example.com>] foo [link <rbac@example.com>]");
